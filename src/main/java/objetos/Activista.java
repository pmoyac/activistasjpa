...
//    @Column(name="ap_materno")
    ...
    @JoinTable(
        ...
        joinColumns = @JoinColumn(name = "idActivista", nullable = false),
        inverseJoinColumns = @JoinColumn(name="idProblema", nullable = false)
    )
    ...
    public String toString() {
        return "Activista{" + "id=" + id + ", nombres=" + nombres + ", ap_paterno=" + ap_paterno + ", ap_materno=" + ap_materno + ", telefono=" + telefono + ", fechaInicioLabores=" + fechaInicioLabores.getTime() + '}';
    }
